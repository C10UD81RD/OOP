...
{
    [InlineData(false, new double[] { double.NaN, -2, -2, -2 })]
    [InlineData(false, new double[] { 6, 2, 2, 2 })]
    ...
    [InlineData(false, new double[] { double.NaN, -2, -2, -2 })]
    [InlineData(false, new double[] { 1.732, 2, 2, 2 })]
    [InlineData(true, new double[] { double.NaN, -2, -10 })]
    [InlineData(true, new double[] { 75.398, 2, 10 })]
    ...
    [InlineData(false, new double[] { double.NaN, 2, 2, 2 })]
    [InlineData(true, new double[] { double.NaN, -2, -10 })]
    [InlineData(true, new double[] { 41.887, 2, 10 })]
